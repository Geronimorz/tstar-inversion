    ...
    if doplotspec:
        for sta in staP3lst:
            if saving[sta][2]['good'][0]:
                ...
                tstarsub.plotspec(plotspecloglog,pfitting,pfitting1,pfitting2,pfitting3,lincorrp,saving[sta],sta,orid,'P',lnmomenP,
                                  bestfcp,bestalpha,3)
...
# =============================================================================
#                     if sfitting>0.7 and sfitting1>0.2:
#                         tstarsub.plotspec(plotspecloglog,sfitting,sfitting1,sfitting2,sfitting3,lincorrs,saving[sta],sta,orid,'S',lnmomenS,bestfcs,bestalpha,3)
# =============================================================================
                    tstarsub.plotspec(plotspecloglog,sfitting,sfitting1,sfitting2,sfitting3,lincorrs,saving[sta],sta,orid,'S',lnmomenS,
                                      bestfcs,bestalpha,3)
